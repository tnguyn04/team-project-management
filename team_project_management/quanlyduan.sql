...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 06, 2025 lúc 05:12 PM
...
(15, 'Triển khai hệ thống lên server và chạy thử nghiệm', 'Bai thuc hanh so 8.pdf', '2025-12-06 03:30:00', '2025-12-14 01:30:00', NULL, 1, 7),
...
(20, 'Thiết kế cơ sở dữ liệu: Users, Products, Orders, Cart, Payments', 'jquery-3.7.1.min.js', '2025-12-05 01:55:00', '2025-12-09 01:55:00', NULL, 2, 1),
(21, 'Xây dựng API đăng ký / đăng nhập và phân quyền người dùng', NULL, '2025-12-06 01:56:00', '2025-12-14 01:56:00', NULL, 2, 1),
...
--
ALTER TABLE `duan`
  MODIFY `IDDuAn` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT cho bảng `nguoidung`
--
ALTER TABLE `nguoidung`
  MODIFY `IDNguoiDung` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT cho bảng `nhom`
--
ALTER TABLE `nhom`
  MODIFY `IDNhom` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `tinnhan`
  MODIFY `IDTinNhan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
